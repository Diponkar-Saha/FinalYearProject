...
data class CohortInfoFragmentArgs(
  ...
  companion object {
    @JvmStatic
    fun fromBundle(bundle: Bundle): CohortInfoFragmentArgs {
      bundle.setClassLoader(CohortInfoFragmentArgs::class.java.classLoader)
      val __cohort : Cohort?
      ...
      return CohortInfoFragmentArgs(__cohort)
    }
  }
}
