...
public abstract class Hilt_AddNewCohort extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddNewCohort(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNewCohort_GeneratedInjector) this.generatedComponent()).injectAddNewCohort(UnsafeCasts.<AddNewCohort>unsafeCast(this));
    }
  }
