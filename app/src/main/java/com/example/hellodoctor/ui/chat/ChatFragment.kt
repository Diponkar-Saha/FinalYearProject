...
class ChatFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val ee= FirebaseAuth.getInstance().currentUser?.uid.toString()
//        String userId = FirebaseAuth.instance.currentUser().uid

//photoUrl: String
        firestore = FirebaseFirestore.getInstance()
        firestore.collection("users").document(ee)
            .get()
            .addOnSuccessListener {
                 status=it.data?.get("photoUrl").toString()
                   }
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        if (status=="public"){
           // menu.findItem(R.id.item_go_to_tasks).setVisible(false)
            menu.findItem(R.id.delete_cohort_menu_item).setVisible(false)
            menu.findItem(R.id.add_new_member_menu_item).setVisible(false)
            menu.findItem(R.id.cohort_info_menu_item).setVisible(false)
