...
public abstract class Hilt_AddNewTaskFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddNewTaskFragment() {
    super();
  }

  Hilt_AddNewTaskFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNewTaskFragment_GeneratedInjector) this.generatedComponent()).injectAddNewTaskFragment(UnsafeCasts.<AddNewTaskFragment>unsafeCast(this));
    }
  }
