...
public abstract class Hilt_DoctorDashFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DoctorDashFragment() {
    super();
  }

  Hilt_DoctorDashFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DoctorDashFragment_GeneratedInjector) this.generatedComponent()).injectDoctorDashFragment(UnsafeCasts.<DoctorDashFragment>unsafeCast(this));
    }
  }
