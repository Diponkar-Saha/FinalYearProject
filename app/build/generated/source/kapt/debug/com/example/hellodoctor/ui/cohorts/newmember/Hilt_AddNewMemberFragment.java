...
public abstract class Hilt_AddNewMemberFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNewMemberFragment_GeneratedInjector) this.generatedComponent()).injectAddNewMemberFragment(UnsafeCasts.<AddNewMemberFragment>unsafeCast(this));
    }
  }
