...
public abstract class Hilt_CohortInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CohortInfoFragment() {
    super();
  }

  Hilt_CohortInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CohortInfoFragment_GeneratedInjector) this.generatedComponent()).injectCohortInfoFragment(UnsafeCasts.<CohortInfoFragment>unsafeCast(this));
    }
  }
