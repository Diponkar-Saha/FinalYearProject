...
public abstract class Hilt_CohortsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CohortsFragment() {
    super();
  }

  Hilt_CohortsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CohortsFragment_GeneratedInjector) this.generatedComponent()).injectCohortsFragment(UnsafeCasts.<CohortsFragment>unsafeCast(this));
    }
  }
